(function ($) {
    ...
    designerModule.controller('ManageItemsCtrl', ['$scope', 'propertyService', 'sfLinkService', function ($scope, propertyService, linkService) {
        ...
        $scope.addListItem = function () {
            ...
            //Working
            //$("#add-list-item").prop("disabled", true);
            ...
            console.log("outer html",$scope.properties.ImageId_Single.PropertyValue);
            ...
            if ($scope.listItems.length >= 2) {
                alert("You can not enter more than 2 items.");
                return;
            }
            ...
            //rnd start 
           // console.log(linkService.getHtmlLink($scope.proxy.selectedItem)[0]);
            
           // $(linkService.getHtmlLink($scope.proxy.selectedItem)[0]).html('Hello World'); 
            ///end
