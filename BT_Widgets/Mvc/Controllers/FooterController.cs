...
using BT_Widgets.Mvc.Models.Footer;

namespace BT_Widgets.Mvc.Controllers
{
    //[EnhanceViewEngines]
    [ControllerToolboxItem(Name = "Footer", Title = "Footer", SectionName = "Test_BT")]
