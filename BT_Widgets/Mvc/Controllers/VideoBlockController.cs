...
using BT_Widgets.Mvc.Models.VideoBlock;

namespace BT_Widgets.Mvc.Controllers
{
    //[EnhanceViewEngines]
    [ControllerToolboxItem(Name = "VideoBlock", Title = "Video-Block", SectionName = "Test_BT")]
    public class VideoBlockController : Controller
    {
