...
using BT_Widgets.Mvc.Models.ResourceDetailLandingView;

namespace BT_Widgets.Mvc.Controllers
{
    //[EnhanceViewEngines]
    [ControllerToolboxItem(Name = "ResourceDetailLandingView", Title = "Resource-Detail-Landing-View", SectionName = "Test_BT")]
    public class ResourceDetailLandingViewController : Controller
    {
        ...
        {
            int cnt = 0;
            List<ResourceDetailLandingView> m_ListObject = new List<ResourceDetailLandingView>();
            this.ViewBag.ListTitle = this.ListTitle;
            this.ViewBag.ListType = this.ListType;

            foreach (var strval in this.DeserializeItems())
            {
                ResourceDetailLandingView m_object = new ResourceDetailLandingView();
