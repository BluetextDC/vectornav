...
using BT_Widgets.Mvc.Models.FullImageRotator;

namespace BT_Widgets.Mvc.Controllers
{
    //[EnhanceViewEngines]
    [ControllerToolboxItem(Name = "FullImageRotator", Title = "Full-Image-Rotator", SectionName = "Blue Text")]
    public class FullImageRotatorController : Controller
    {
