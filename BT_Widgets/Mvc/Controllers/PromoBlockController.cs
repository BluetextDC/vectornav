...
using BT_Widgets.Mvc.Models.PromoBlock;

namespace BT_Widgets.Mvc.Controllers
{
    //[EnhanceViewEngines]
    [ControllerToolboxItem(Name = "PromoBlock", Title = "Promo-Block", SectionName = "Test_BT")]
    public class PromoBlockController : Controller
    {
