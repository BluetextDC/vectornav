...
using BT_Widgets.Mvc.Models.FourColumnPromo;

namespace BT_Widgets.Mvc.Controllers
{
    //[EnhanceViewEngines]
    [ControllerToolboxItem(Name = "FourColumnPromo", Title = "4-Column Promo", SectionName = "Blue Text")]
    public class FourColumnPromoController : Controller
    {
