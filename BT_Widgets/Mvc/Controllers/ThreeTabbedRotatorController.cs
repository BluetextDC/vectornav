...
using BT_Widgets.Mvc.Models.ThreeTabbedRotator;

namespace BT_Widgets.Mvc.Controllers
{
    //[EnhanceViewEngines]
    [ControllerToolboxItem(Name = "ThreeTabbedRotator", Title = "3-Tabbed-Rotator", SectionName = "Test_BT")]
    public class ThreeTabbedRotatorController : Controller
    {
