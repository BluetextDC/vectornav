...
using BT_Widgets.Mvc.Models.ApplicationHero;

namespace BT_Widgets.Mvc.Controllers
{
    //[EnhanceViewEngines]
    [ControllerToolboxItem(Name = "ApplicationHero", Title = "Application-Hero", SectionName = "Test_BT")]
    public class ApplicationHeroController : Controller
    {
