...
using BT_Widgets.Mvc.Models.FiftyFiftyTwoColumn;
...
{
    //[EnhanceViewEngines]
    [ControllerToolboxItem(Name = "FiftyFiftyTwoColumn", Title = "50-50-Two-Column", SectionName = "Test_BT")]
    public class FiftyFiftyTwoColumnController : Controller
    {
        ...
        {
            int cnt = 0;
            List<FiftyFiftyTwoColumn> m_ListObject = new List<FiftyFiftyTwoColumn>();
            this.ViewBag.ListTitle = this.ListTitle;
            this.ViewBag.ListType = this.ListType;

            foreach (var strval in this.DeserializeItems())
            {
                FiftyFiftyTwoColumn m_object = new FiftyFiftyTwoColumn();
