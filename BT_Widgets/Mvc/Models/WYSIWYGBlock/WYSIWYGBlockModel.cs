...
namespace BT_Widgets.Mvc.Models.WYSIWYGBlock
{
    public class WYSIWYGBlockModel
    {
        ...
        #endregion 
        public WYSIWYGBlockViewModel GetViewModel()
        {
            var viewModel = new WYSIWYGBlockViewModel();
                       
            viewModel.RichText = this.RichText;
            return viewModel;
        }
    }
}