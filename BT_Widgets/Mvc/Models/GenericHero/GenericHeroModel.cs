...
namespace BT_Widgets.Mvc.Models.GenericHero
{
    public class GenericHeroModel
    {
        ...
        #endregion 
        public GenericHeroViewModel GetViewModel()
        {
            var viewModel = new GenericHeroViewModel();
