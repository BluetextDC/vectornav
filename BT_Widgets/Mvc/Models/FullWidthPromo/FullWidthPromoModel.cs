...
namespace BT_Widgets.Mvc.Models.FullWidthPromo
{
    public class FullWidthPromoModel
    {
        public string Link { get; set; }

        public string Title_Jp { get; set; }
        public string Sub_Title_Jp { get; set; }
        ...
        #endregion 
        public FullWidthPromoViewModel GetViewModel()
        {
            var viewModel = new FullWidthPromoViewModel();

            viewModel.Link = this.Link;
            viewModel.Title_JpVM = this.Title_Jp;
            viewModel.Sub_Title_JpVM = this.Sub_Title_Jp;
