...
namespace BT_Widgets.Mvc.Models.TabbedListingContent
{
    public class TabbedListingContentModel
    {
        ...
        #endregion 
        public TabbedListingContentViewModel GetViewModel()
        {
            var viewModel = new TabbedListingContentViewModel();
