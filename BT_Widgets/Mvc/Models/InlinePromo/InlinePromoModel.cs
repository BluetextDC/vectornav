...
namespace BT_Widgets.Mvc.Models.InlinePromo
{
    public class InlinePromoModel
    {
        ...
        #endregion 
        public InlinePromoViewModel GetViewModel()
        {
            var viewModel = new InlinePromoViewModel();
